...
describe('FavouritesService', () => {
  ...
  describe('getActiveMapItemsForFavourite', () => {
    ...
    it('does not throw a FavouriteIsInvalidError if ignoerErrors is set to true', () => {
      service['availableMaps'] = [
        {
          id: 'StatGebAlterZH',
          uuid: '246fe226-ead7-4f91-b735-d294994913e0',
      ...
      const omittedError = new FavouriteIsInvalid(`Die Konfiguration für den Zeitschieberegler der Karte 'Gebäudealter' ist ungültig.`);

      expect(() => service.getActiveMapItemsForFavourite(activeMapItemConfigurations, true)).not.toThrow(omittedError);
    });
