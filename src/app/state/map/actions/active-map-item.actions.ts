...
import {TimeSliderExtent} from '../../../map/interfaces/time-slider-extent.interface';
...
export const ActiveMapItemActions = createActionGroup({
  ...
  events: {
    ...
    'Set Time Slider Extent': props<{timeSliderExtent: TimeSliderExtent; activeMapItem: ActiveMapItem}>()
  }
});
