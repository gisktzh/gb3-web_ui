...
import {StartPageSearchMobileComponent} from './components/start-page-search/start-page-search-mobile/start-page-search-mobile.component';
...
@NgModule({
  declarations: [
    ...
    StartPageSearchMobileComponent,
  ],
