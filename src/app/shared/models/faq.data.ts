...
export const faqData: FaqCollection[] = [
  {
    ...
    items: [
      ...
      {
        question:
          "Kann ich von einem mobilen Gerät auf das Geoportal zugreifen?",
        answer:
      ...
      {
        question:
          "Warum werde ich bei einigen Karten auf maps.zh.ch weitergeleitet?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Nein, die Bearbeitung von Daten ist im GIS-Browser nicht möglich.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Weitere Informationen zu den Karten und den verwendeten Geodatensätzen finden Sie im Geodatenkatalog.",
      },
      {
        question:
          "Welcher Bezugsrahmen gilt für die Koordinaten im Kanton Zürich?",
        answer:
      ...
      {
        question:
          "Wie kann ich den Guide, der durch die wichtigsten Funktionen des GIS-Browsers führt, erneut öffnen?",
        answer:
          "Sie können im GIS-Browser bei den aktiven Karten das Fragezeichen-Symbol klicken, damit sich der Guide erneut öffnet.",
      },
    ],
  },
  {
    ...
    items: [
      {
        question:
          "Wie kann ich Karten oder Layer im GIS-Browser anzeigen/hinzufügen?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Klicken Sie auf die Schaltfläche «Legende», um diese anzuzeigen.",
      },
      {
        question:
          "Wie kann ich die Transparenz resp. das Deckvermögen einer Karte ändern?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "Warum ist der Download-Knopf grau und kann nicht angeklickt werden?",
        answer:
      ...
      {
        question:
          "Warum können einige Produkte bei der Bestellung nicht ausgewählt werden?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Wenn sie Ihre Bestellung bereits abgeschickt haben, können Sie diese nicht mehr stornieren.",
      },
      {
        question: "Wie kann ich die Auswahl des Gebietes verändern?",
        answer:
          "Schliessen Sie das aktuelle Bestellmenü, starten Sie eine neue Bestellung und wählen Sie ein neues Gebiet aus.",
      },
      {
        question:
          "Für welchen Perimeter werden bei einer Gemeindeauswahl Daten geliefert?",
        answer:
          "Die Daten werden kachelweise ausgeliefert. Jede angeschnittene Kachel wird ganz ausgeliefert.",
      },
      {
        question:
          "Warum ist das E-Mail mit dem Download-Link nicht angekommen?",
        answer:
      ...
      {
        question:
          "Können die offenen Geodaten auch als Geodienste bezogen werden?",
        answer:
      ...
      },
      {
        ...
        answer:
          'Verwenden Sie die Schaltfläche "Drucken" und wählen Sie das gewünschte Format aus.',
      },
      {
        question:
      ...
      {
        question:
          "Ich will kantonale Daten veröffentlichen. Welche Quelle soll ich angeben?",
        answer:
