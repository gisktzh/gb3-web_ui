...
import {DrawinLayerPrefix} from '../enums/drawing-layer.enum';
...
export class MapConstants {
  ...
  public static readonly INTERNAL_LAYER_PREFIX = DrawinLayerPrefix.Internal;
  public static readonly USER_DRAWING_LAYER_PREFIX = DrawinLayerPrefix.Drawing;
