...
import {OrderStatus, orderStatusKeys, OrderStatusType} from '../../../../interfaces/geoshop-order-status.interface';
...
export class GeoshopApiService extends BaseApiService {
  ...
  private parseStatus(apiStatus: string): {type: OrderStatusType; message?: string} {
