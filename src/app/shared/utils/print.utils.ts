...
export class PrintUtils {
  public static calculateGb2PrintPreviewExtent(
    width: number,
    height: number,
    scale: number,
  ): {
  ...
  public static createPrintPreviewArea(center: Coordinate, extentWidth: number, extentHeight: number): PolygonWithSrs {
